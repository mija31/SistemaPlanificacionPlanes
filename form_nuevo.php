...
<body>     
      <form role="form" name='crear_plan' method='POST' action='crear_plan_nuevo.php'>
            <?php
            include('formN1.php');
            include("formN2.php");
            ?>
          <div id="nombreMat_nuevo" hidden="yes">
            <input  type="text" class="form-control" name="seleccionado_nuevo" value="<?php echo $nombre_url;?>" readonly="readonly">
            
        </div>
          <div class="row row-centered">
              <button id="nuevo_guardar"  name="enviar" type="submit" class="btn btn-danger">Guardar</button> 
           <button id="nuevo_cancelar" type="submit" class="btn btn-danger">Cancelar</button>
          </div>
    </form>
