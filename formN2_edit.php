...
if(!$con )
{
    ...
    $consulta= pg_query($con,"SELECT justificacion,objetivo,metodologia,evaluacion,bibliografia FROM plan_nuevo WHERE id_plan_ant='$id_ant';");
...
<div class="panel panel-primary">
        ...
        <textarea id="justificacion2" class="form-control" rows="10" type='text' name='justificacion2'><?php echo $justificacion;?></textarea>
        </div>
    </div>
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <label class="control-label">numere los objetivos Ejm: 1.-:</label><br>
                ...
                <div class="panel-body">
                    <textarea id="objText" class="form-control" rows="10" name="objetivo" type="text" ><?php echo $obj;?></textarea>
                </div>
...
<div class="panel panel-primary">
        ...
        <div class="panel-body">
           <textarea id="metodologia2" class="form-control" rows="10" type='text' name='metodologia2'><?php echo $metodo;?></textarea>        
    </div>
</div>
<div class="panel panel-primary">
...
<div class="panel panel-primary">
        ...
        <div class="panel-body">
           <textarea id="criterios2" class="form-control" rows="10" type='text' name="criterios2"><?php echo $evalu;?></textarea>        
    </div>
</div>
<div class="panel panel-primary">
        <div class="panel-heading">VIII. BIBLIOGRAFÍA.</div>
        <div class="panel-body">
           <textarea id="bilbiografia2" class="form-control" rows="10" type='text' name="bibliografia2" ><?php echo $bibio;?></textarea>        
    </div>
</div>
